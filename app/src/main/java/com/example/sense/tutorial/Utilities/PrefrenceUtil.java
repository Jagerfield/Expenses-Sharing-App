...
public class PrefrenceUtil
{
    ...
    public static void setInt(Context c, String key, int val) {
        SharedPreferences.Editor e = c.getSharedPreferences(C.APP_PREFERENCES, c.MODE_PRIVATE).edit();
        e.putInt(key, val);
        e.commit();
    }
    ...
    {
        SharedPreferences e = c.getSharedPreferences(C.APP_PREFERENCES, c.MODE_PRIVATE);
