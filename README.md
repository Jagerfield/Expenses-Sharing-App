...
```
1. I created an app to access users data on a WampServer. The server's db contains a demo table "users". I wrote the server-side APIs in php. The app uses the Retrofit REST client to do GET, POST (and eventually PUT, DELETE) actions on the table, and post user-entries with pictures (optional). 
