...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2017 at 01:47 PM
...
CREATE TABLE `events` (
  ...
  `event_created_at` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(19, 'London', 5, 'London visit', '', 1484409664);
...
CREATE TABLE `transactions` (
  ...
  `transaction_created_at` bigint(20) UNSIGNED NOT NULL,
  `transaction_updated_at` bigint(20) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `events`
  MODIFY `event_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `events_participants`
--
ALTER TABLE `events_participants`
  MODIFY `ep_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
